...
<html>
  ...
  <body>
        ...
        <form action="UsuarioServlet?action=autocadastro" method="POST" class="card text-center bg-info">
          ...
          <div class="card-body">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name="rua" placeholder="Logradouro" disabled />
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name="bairro" placeholder="Bairro" disabled />
    ...
    <script rel="preload" as="script" src="./js/jquery_mask.js"></script>
